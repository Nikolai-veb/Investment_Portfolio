...
class Bonds(models.Model):
    ...
    opening_price = models.DecimalField("Цена открытия", default=0)
    closing_price = models.DecimalField("Цена закрытия", default=0)
    coupon = models.DecimalField("Купон", default=0)
    bonds_in_circulation = models.DecimalField("Облигаций в обращении", default=0)
...
class ETF(models.Model):
    ...
    closing_price = models.DecimalField("Цена закрытия", default=0)
    dividends = models.DecimalField("Дивиденты", default=0)
    assets_in_circulation = models.DecimalField("Активов в обращении", default=0)
